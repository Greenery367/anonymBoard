	...
	<div class="main">
		...
		<div class="main-board">
			<form action="write-board" method="post">
				...
				<div class="form-box">
					<label>글 제목 : </label> <input type="text" placeholder="제목을 입력해주세요"
						name="title" id="title" required>
				</div>
				<div class="form-box">
					<label>글 내용 : </label> <input class="content-form" type="textarea"
						placeholder="내용을 입력해주세요" name="content" id="content" required>
				</div>
				<div class="form-box">
					<label>글쓴이 : </label> <input type="text" placeholder="이름을 입력해주세요"
